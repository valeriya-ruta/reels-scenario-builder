...
▸ СЛАЙДИ 1, 2, 3 — ЦЕ ТРИ ОКРЕМІ ХУКИ (type="cover").
  ...
  САМОДОСТАТНІЙ — читатись як окремий пост сам по собі. «Самодостатній» — це про ЗМІСТ і
  СЕНС, а НЕ про вигляд: хук може бути title АБО title+body (текст), як зручніше. НІКОЛИ не
  розбивай одну думку на два хуки (слайд 3 не має бути продовженням слайда 2) — це мають бути
  три РІЗНІ думки, у кожній читач має ВПІЗНАТИ СЕБЕ.
